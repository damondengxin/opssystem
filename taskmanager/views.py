...
from .models import Cron_Config,Log_Cron_Config
from cmdb.models import  Server_Assets
from opssystem.utils.ssh_tools import SSHManage
from opssystem.utils import base
from opssystem.tasks import recordCron
from django.contrib.auth.decorators import permission_required
from opssystem.utils.ansible_api_v2 import ANSRunner


@login_required()
@permission_required('opssystem.can_add_cron_config', login_url='/noperm/')
    ...
    if request.method == "GET":
        ...
        if int(cron_status) == 1:
            try:
                ...
                return render('cron/cron_add.html', {"user": request.user,
                                                                 "serverList": serverList,
