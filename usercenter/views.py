...
from codedeploy.models import Project_Order
...
def user_manage(request):
    if request.method == "GET":
        ...
        return render(request,'users/user_manage.html',
                                  {"user": request.user, "userList": userList, "groupList": groupList})
    ...
    if request.method == "GET":
        ...
        try:
            ...
            return render(request,'users/user_info.html',
                                      {"user": request.user, "errorInfo": "用户资料修改错误：%s" % str(e)})
    ...
    if request.method == "GET":
        ...
        try:
            ...
            return render(request,'users/group_info.html',
                                      {"user": request.user, "permList": permList, "group": group})
        except Exception as e:
            return render(request,'users/group_info.html',
